...
import ChangePassword from './components/account-setting/account-setting-security/account-change-password.jsx';
import SecurityQuestions from './components/account-setting/account-setting-security/account-security-questions.jsx';
import LoginHistory from './components/account-setting/account-setting-security/account-login-history.jsx';
        ...
        <div className='body-middle-container'>
          <Routes>
            <Route path='/'>
              ...
              <Route
                path='/AccountSetup/change-password'
                element={<ChangePassword />}
              />
              <Route
                path='/AccountSetup/security-questions'
                element={<SecurityQuestions />}
              />
              <Route
                path='/AccountSetup/login-history'
