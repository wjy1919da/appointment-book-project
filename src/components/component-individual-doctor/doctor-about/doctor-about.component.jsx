...
// components
import DoctorVoucherCard from '../../../components/doctor-own-profile/doctor-profile-voucher-card.jsx';
...
const DoctorAbout = ({ encodedMemberId }) => {
  ...
  const objArray = [
    ...
    },
    {
      ...
      title: 'test',
      coverImg:
        'http://charm.zihai.shop/uploads/20230309/c901c6b01512a69bb47d71ba661f9dde.png',
      memberId: 108,
      nickname: 'lmlyb',
      avatar:
    ...
    },
    {
      ...
      title: 'e',
      coverImg:
        'http://charm.zihai.shop/uploads/20230311/f735a4a8be791b70c5dc3688671ef421.png',
      memberId: 85,
      nickname: 'dd2',
      avatar:
        'http://dxm72.zihai.shop/uploads/20220321/baf4631f46ca84d67baefc36657f95e8.png',
    ...
    },
    {
      ...
      title: '这次又有',
      coverImg:
        'http://charm.zihai.shop/uploads/20230410/0ae250dbac59a798b7c72abd4f12f9cf.png',
      memberId: 106,
      nickname: '用户1',
      avatar:
        'http://dxm72.zihai.shop/uploads/20220321/baf4631f46ca84d67baefc36657f95e8.png',
  ...
  const getSelectedPosts = () => {
    ...
    if (highlights.length > 0) {
      if (isMobilePhone) {
        // only want to show 2 highlighted posts when user is on mobile
      ...
      {/* <div className='indv-vouchers-big-container'>
        ...
        <div className='vouchers-container'>
          {vouchers?.length > 0 ? (
            ...
            <h3 className='indv-no-vouchers-title'>
              No vouchers currently available, check back later for more great
              deals!
            </h3>
          )}
        </div>
      </div> */}
      <div className='indv-doctor-voucher-card-container'>
        <DoctorVoucherCard />
        <DoctorVoucherCard />
      </div>
