          ...
          <div className="doctor-search-hearder-container-mobile">
            ...
            {isPhone && (
              <div className="doctor-search-header-pic-container-mobile animate__animated animate__slideInUp">
                <img
                  src={DoctorSearchBackground}
                  alt="Doctor Search"
                  className="doctor-search-header-pic-mobile"
                />
              </div>
            )}
            {isIpad && (
              <div className="doctor-search-header-pic-container-ipad animate__animated animate__slideInUp">
                <img
                  ...
                  className="doctor-search-header-pic-ipad"
                />
                <img
                  src={DoctorSearchPhone}
                  alt="Doctor Search Phone"
                  className="doctor-search-header-phone-ipad"
                />
              </div>
            )}
          </div>
