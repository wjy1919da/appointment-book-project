    ...
    return (
        <div className = 'home-section-container'>
            ...
            <div className = 'home-instrument-container'>
                ...
                <div>
                    <SimpleGrid style={{ marginLeft: '20px',marginTop:'10px',marginBottom:'10px', width:'97vw'}} columns={ 4 } spacing={8}>
                        {instrumentsGrid}
                    </SimpleGrid>
                </div>
            </div>
            ...
            <div className = 'home-instrument-container'>
                ...
                <SimpleGrid style={{ marginLeft: '20px',marginTop:'10px', width:'97vw'}} columns={{ base: 5, md:5, lg: 7}} spacing={5}>
                        {proceduresGrid}
                </SimpleGrid>
            </div>
        </div>   
