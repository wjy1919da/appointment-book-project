...
const HomeIndex = () => {
  ...
  const isIpad = useMediaQuery({
    query: `(min-width: 768px) and (max-width: 1132px)`,
  });
    ...
    <div className="home">
      <div className="home-mobile-intro-container">
        <div className="home-title-container">
          ...
          <div className="home-title-inner-container">
            ...
            <div className="home-title-subText">
              <p className="ptext">
                {" "}
                Charm is more than just a platform; it's a thriving community
                that embraces the diversity of beauty and offers a seamless
                experience for all beauty enthusiasts. From subtle enhancements
                to bold transformations, our platform is designed to cater to
          ...
          <div className="home-title-buttons">
            ...
            <button
              type="button"
              onClick={handleShow}
              className="button home-title-button2"
            >
              <img src={VectorPink} alt="Button" className="button-image"></img>
              <span className="button-text">What is Charm </span>
              {/* {isMobile && <span className="button-text">Watch Video</span>} */}
            </button>
            <Modal show={show} onHide={handleClose} size="xl">
              <div
                className="home-buttom-modal-container"
        ...
        <div className="home-mobile-intro-pic-container">
          ...
          <img
            src={HomePic}
            className="home-pic animate__animated animate__slideInDown"
          ></img>
          {/* )} */}
          {/* {isIpad && (
            <img
