 ...
 * 
 */
const AppointmentDetail = ({type, appointmentPending, appointmentObj}) => {
    ...
    const endingText = type === 0 ? 'Declined' : appointmentPending ? 'Waiting for Confirmation' : 'Confirmed Appointment';
        ...
        <div className='appointment-detail-main-container'>
            <div className='appointment-top-info-container'>
                <div className='app-doctor-info-section'>
                    <div className='app-doctor-avatar-container'>
                        <img src={doctorAvatar} className='app-doctor-avatar' alt='doctor profile' />
                    </div>
                    <div className='app-doctor-detail'>
                        ...
                        <span className='app-doctor-detail-text'>Time: 10:00 AM - 10:30 AM EST</span>
                        {/* <div className='app-doctor-detail-combin'>
                            <div className='app-doctor-detail-icon-container'>
            ...
            <div className='app-medium-info-section'>
                ...
                <div className='app-medium-buttons-combin'>
                    <button disabled className='app-medium-button app-medium-text-button' >Eyes</button>
                    <button disabled className='app-medium-button app-medium-text-button' >Lip Filler</button>
                ...
                <div className='app-description-photos-section'>
                    ...
                    <div className='app-description-photos-container'>
                        <div className='app-description-photo-container'>
                            <img className='app-description-photo' src={defaultImg} alt='app description' />
                        </div>
                        <div className='app-description-photo-container'>
                            <img className='app-description-photo' src={defaultImg} alt='app description' />
                        </div>
            ...
            <div className='app-details-record-section'>
                <span className='app-details-record'>Call Record: None / Edit Record: None / Reschedule Record: None / Cancellation Record: None / Refund Record: None / System Refund: None</span>
            </div>
            {type === 0 && <div className='app-ending-duo-buttons-section'>
                <button className='app-ending-reschedule-button' onClick={() => togglePopup(true, 'EditAppointment')} >Reschedule</button>
                <button className='app-ending-cancel-button' >Cancel Appointment</button>
            </div>}
        </div>
    );   
};
