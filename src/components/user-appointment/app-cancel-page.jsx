        ...
        <>
            ...
            <div className='app-cancel-main-container'>
                <div className='app-cancel-title-container'>
                    ...
                    <p className='app-finish-title-text'>Are you sure you wish to cancel your appointment with Charlotte?</p>
                </div>
                ...
                <button className='app-finish-home-button app-finish-button' onClick={() => setIsModalOpen(true)} >Confirm Cancellation</button>
                    <button className='app-finish-appointments-button app-finish-button' onClick={() => togglePopup(true,'mainSection')}>Keep Appointment</button>
                </div>
